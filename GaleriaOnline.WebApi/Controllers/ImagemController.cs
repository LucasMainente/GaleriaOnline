...
namespace GaleriaOnline.WebApi.Controllers
{
    ...
    public class ImagenController : ControllerBase
    {
        ...
        public ImagenController(IImagemRepository repository, IWebHostEnvironment env)
        {
        ...
        public async Task<IActionResult> DeletarImagem(int id)
        {
            ...
            if (System.IO.File.Exists(caminhoFisico))
            {
                ...
                {
                    return StatusCode(500, $"Erro ao deletar arquivo: {ex.Message}");
            ...
            if (!deletado)
            {
                return StatusCode(500, "Erro ao deletar imagem do banco de dados.");
            }
            return NoContent();
        }
    }
